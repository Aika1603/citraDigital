...
<?php
  session_start();
  if(!isset($_SESSION["image"]) OR !isset($_POST["green"]) OR !isset($_POST["blue"]) OR !isset($_POST["red"])){
...
try {
  ...
  $filter = Grafika::createFilter('Colorize', $_POST["red"], $_POST["green"], $_POST["blue"]);
